...
def recognize_speech_from_video(
    model, audio_queue, results, samplerate=16000, framerate=60
):
...
def display_transcriptions(
    frame, transcriptions, partial_transcription, 
    x0, y0, dy, prev_length_difference, max_length=40
):
...
def main():
    ...
    input_video = ffmpeg.input('C:/Storage/Source Videos/TranslationVideos/output_with_subtitles.mp4')
